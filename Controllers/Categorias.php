<?php
	class Categorias extends Controllers{
		...
		{
			//Comienza llamando al constructor del controlador padre.
			parent::__construct();
			session_start();
			...
			if(empty($_SESSION['login']))
			{
				...
				//redirigiendo al usuario a la página de inicio de sesión si no está autenticado.
				header('Location: '.base_url().'/login');
				die();
			}
			getPermisos(MCATEGORIAS);

			//obtener los permisos del usuario para la gestión de categorías.
		}

		public function Categorias()
		{
			//cargar la vista principal de categorías.
			if(empty($_SESSION['permisosMod']['r'])){
				header("Location:".base_url().'/dashboard');
			}
			//Verifica si el usuario tiene permisos de lectura para acceder a esta página, 
			//de lo contrario, lo redirige al panel de control.
