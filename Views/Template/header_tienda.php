<?php 
	...
	$tituloPreguntas = !empty(getInfoPage(PREGUNTAS)) ? getInfoPage(PREGUNTAS)['titulo'] : "";
	$infoPreguntas = !empty(getInfoPage(PREGUNTAS)) ? getInfoPage(PREGUNTAS)['contenido'] : "";
 ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body class="animsition">
	...
	<header>
		...
		<div class="container-menu-desktop">
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<!-- Logo desktop -->		
					<a href="<?= base_url(); ?>" class="logo w-25 p-3">
		...
		<div class="wrap-header-mobile">
			<!-- Logo moblie -->		
			<div class="logo-mobile w-25 p-3">
